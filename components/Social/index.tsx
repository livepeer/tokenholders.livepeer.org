  ...
  return (
    <Flex {...props}>
      ...
      <a
        ...
        rel="noopener noreferrer"
      >
        <FaDiscourse sx={{ mr: 2, color: "white" }} />
      </a>
      <a
